...
import (
	...
	for_core_protos_go_proto "github.com/quant1x/quant/utils/tensorflow/tsl/protobuf/for_core_protos_go_proto"
...
type HistogramProto = for_core_protos_go_proto.HistogramProto
...
func (x *Summary_Value) GetHisto() *for_core_protos_go_proto.HistogramProto {
...
type Summary_Value_Histo struct {
	Histo *for_core_protos_go_proto.HistogramProto `protobuf:"bytes,5,opt,name=histo,proto3,oneof"`
}
...
var file_tensorflow_core_framework_summary_proto_goTypes = []interface{}{
	...
	(*for_core_protos_go_proto.HistogramProto)(nil), // 8: tensorflow.HistogramProto
